...
$link_cmd_suffix="\"\$\{newallargs\[\@\]\}\" \$FMPICH -L/soft/perftools/autoperf/lib -lautoperf -L/bgsys/drivers/ppcfloor/bgpm/lib/ -lbgpm $4 -L/soft/perftools/autoperf/lib -lautoperf -L/bgsys/drivers/ppcfloor/bgpm/lib/ -lbgpm";
